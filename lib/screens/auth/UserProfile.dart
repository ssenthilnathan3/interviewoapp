...
import 'package:interviewo/utils/widget_utils.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  String? name, email, phone_number, imagePath, about;
  _getUserData() async {
    final SharedPreferences _prefs = await SharedPreferences.getInstance();
    setState(() {
      name = _prefs.getString('name') ?? '';
      email = _prefs.getString('email') ?? '';
      phone_number = _prefs.getString('phone_number') ?? '';
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          buildUserInfoDisplay(phone_number!, 'Phone', EditPhoneFormPage()),
  ...
  Widget buildAbout(description) => Padding(
      padding: EdgeInsets.only(bottom: 10),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  void navigateSecondPage(Widget editForm) {
    ...
    Navigator.push(context as BuildContext, route).then(onGoBack);
  }
}
...
class EditPhoneFormPageState extends State<EditPhoneFormPage> {
  ...
  void updateUserValue(String phone) async {
    ...
    _prefs.setString('phone_number', formattedPhoneNumber);
  }
              ...
              child: SizedBox(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      userImage = await File(image.path).copy(imageFile.path);
                    },
                    child: Image.network(userImage.image),
                  ))),
          Padding(
              padding: EdgeInsets.only(top: 40),
              child: Align(
